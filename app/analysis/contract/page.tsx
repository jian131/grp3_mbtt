          ...
          <div className="glass-card rounded-2xl p-6 border border-white/10">
            ...
            <div className="flex gap-3 mt-4">
              <button
                ...
                className="px-4 py-2 bg-slate-700 hover:bg-slate-600 text-gray-200 rounded-lg text-sm transition-colors"
              >
                📋 Dùng mẫu
              </button>
              <button
            ...
            <div className="flex items-center justify-between mb-4">
              ...
              {result && (
                <button
                  ...
                  className="px-3 py-1 bg-slate-700 hover:bg-slate-600 text-gray-200 rounded-lg text-sm transition-colors"
                >
